...
export default function Auth() {
  ...
  const signUp = (data:zod.infer<typeof authSchema>) => {
    ...
    return (
      <ImageBackground
        source={{
          uri: 'https://plus.unsplash.com/premium_photo-1683746792467-c6ae33d06c20?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        }}
